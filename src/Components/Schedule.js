...
class Schedule extends Component {
    ...
    render() {
        ...
        return(
            <TouchableOpacity onPress={() => this.props.navigation.navigate('InspectorDetail',{'inspector': this.props.item})}>
                ...
                <View style={[style.scheduleInspectorWrapper]}>                        
                        ...
                        />
                        <Text style={[styles.nameTxt,{textAlign:'center', marginTop:6, textDecorationLine:'underline'}]}>{this.props.item.InspectorName}</Text>
                    ...
                    <View style={style.flatListItemTextRow}>
                        <Text style={style.nameTxt}>{this.props.item.CompanyName}</Text>
                        <Text numberOfLines={4} style={style.nameTxt2}>{this.props.item.CompanyBio}</Text>
                    </View>
