...
import {Platform, StatusBar, StyleSheet, View, ScrollView, Image, TouchableOpacity, AsyncStorage} from 'react-native';
import styles from '../../../assets/styles/style.js';
import { Container, Header, Content, Button, Card, CardItem, Toast,
	 Text, Body, Form, Item, Root, Left, Right, Title } from 'native-base';
